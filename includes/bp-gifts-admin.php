...
<?php
	...
	if ( isset($_GET['mode']) && isset($_GET['gift_id'])) {
		...
		<form action="<?php echo site_url() . '/wp-admin/admin.php?page=bp-gifts-settings' ?>" name="gifts-settings-form" id="gifts-settings-form" method="post">
...
<form action="<?php echo site_url() . '/wp-admin/admin.php?page=bp-gifts-settings' ?>" method="post" enctype="multipart/form-data" name="gift-upload-form" id="gift-upload-form" >			
...
<br/>
			...
			echo '<a href="'. site_url() . '/wp-admin/admin.php?page=bp-gifts-settings&gift_id='.$giftitem->id.'&mode=edit" /> <img src="'. bp_get_root_domain() .'/wp-content/plugins/buddypress-gifts-latest-2014/includes/images/admin/edit.png" /></a>';

			echo '<a href="'. site_url() . '/wp-admin/admin.php?page=bp-gifts-settings&gift_id='.$giftitem->id.'&mode=delete" /> <img src="'. bp_get_root_domain() .'/wp-content/plugins/buddypress-gifts-latest-2014/includes/images/admin/delete.png" /></a>';
