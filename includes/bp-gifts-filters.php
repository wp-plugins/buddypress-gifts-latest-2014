 ...
 */
 ...
 add_filter( 'bp_gifts_get_item_name', 'wp_filter_kses', 1 );

/**
 * In your save() method in 'bp-gifts-classes.php' you will have 'before save' filters on
 * values. You should use these filters to attach the wp_filter_kses() function to them.
 */

 add_filter( 'bp_gifts_data_gift_name_before_save', 'wp_filter_kses', 1 );
 add_filter( 'bp_gifts_data_gift_image_before_save', 'wp_filter_kses', 1 );
 add_filter( 'bp_gifts_data_category_before_save', 'wp_filter_kses', 1 );
